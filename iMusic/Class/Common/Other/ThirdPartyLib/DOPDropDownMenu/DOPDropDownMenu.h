...
/** <NSString *> */
@property (nonatomic, strong) NSArray *indicatorImageNames;// 自定义指示器图片(在设置dataSource之前调用才会生效)

/** <NSNumber *> */
@property (nonatomic, strong) NSArray *indicatorAnimates;  // 指示器图片是否可以transform(在设置dataSource之前调用才会生效)
